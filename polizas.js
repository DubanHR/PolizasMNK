      ...
      if(respuesta.Formulario === "1"){
          ...
          fetch(url, {
              ...
              if(data.statusCode === 1){
               ...
               mensajeFormulario("\u200B", "❗️Hemos detectado un error en la información ingresada en datos para pago, por favor, revisá y corregí los datos",
                  "Da clic en el botón “Datos para pago”  para reintentar", "DATOS PARA PAGO", FLOW_DATOS_PAGO_MNK);
